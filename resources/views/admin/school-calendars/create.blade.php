...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Add New School Calendar</h1>
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
        <div class="p-6">
            <form action="{{ route('admin.school-calendars.store') }}" method="POST">
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="school_calendar_desc" id="school_calendar_desc" 
                        ...
                        value="{{ old('school_calendar_desc') }}" required>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="school_calendar_short_desc" id="school_calendar_short_desc" 
                        ...
                        value="{{ old('school_calendar_short_desc') }}" required>
                ...
                <div class="mb-6">
                    <div class="flex items-center">
                        <input type="checkbox" name="is_selected" id="is_selected" class="mr-2" value="1" {{ old('is_selected') ? 'checked' : '' }}>
